 ...
 */
export function Seed(seed: string): () => number {
 ...
 */
export function Color(random = Math.random): number {
 ...
 * @param random - The random function to be used (defaults to Math.random)
 */
export function Range(min: number, max: number, random = Math.random): number {
 ...
 * @param random - The random function to be used (defaults to Math.random)
 */
export function Item<T>(obj: T, random = Math.random): T[keyof T] {
 ...
 * @returns
 */
export function Bool(weight = 0.5, random = Math.random): boolean {
 ...
 */
export function Float(min: number, max: number, random = Math.random) {
 ...
 * @param random - The random function to be used (defaults to Math.random)
 */
export function Int(min: number, max: number, random = Math.random) {
...
export function Arr(
  ...
  for (let i = 0; i < count; i++) {
    const sym = Item(seeds);
    if (sym) {
      arr.push(type === "string" ? sym.toString() : sym);
    }
  }

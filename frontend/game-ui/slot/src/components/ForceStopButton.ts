import { AnimatedSprite, Assets, Circle, Container, Sprite, Texture } from "pixi.js";
import { BaseButton } from "./BaseButton";

export class ForceStopButton extends BaseButton {
  ...
  private getButtonTextures(): Texture[] {
    ...
    for (let i = 0; i <= 13; i++) {
      const frame = `spin-Start_2_${i.toString().padStart(2, "0")}.png`;
